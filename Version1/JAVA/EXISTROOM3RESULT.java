...
public class EXISTROOM3RESULT extends AppCompatActivity {

    int array[] = {0,0,0,0,0,0};
    int number[] = {0,0,0,0,0,0};
    private Button mbtnEXISTROOM3END;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_existroom3_result);

        mbtnEXISTROOM3END = findViewById(R.id.btn_existroom3end);
        mbtnEXISTROOM3END.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = null;
                intent = new Intent(EXISTROOM3RESULT.this,EXISTROOM.class);
        ...
        ImageView resulttouzi1_png = (ImageView) findViewById(R.id.img_existroom3resulttouzi1);
        switch(array[0]) {
            case 1:
        ...
        ImageView resulttouzi2_png = (ImageView) findViewById(R.id.img_existroom3resulttouzi2);
        switch(array[1]) {
            case 1:
        ...
        ImageView resulttouzi3_png = (ImageView) findViewById(R.id.img_existroom3resulttouzi3);
        switch(array[2]) {
            case 1:
        ...
        ImageView resulttouzi4_png = (ImageView) findViewById(R.id.img_existroom3resulttouzi4);
        switch(array[3]) {
            case 1:
        ...
        ImageView resulttouzi5_png = (ImageView) findViewById(R.id.img_existroom3resulttouzi5);
        switch(array[4]) {
            case 1:
        ...
        ImageView resulttouzi6_png = (ImageView) findViewById(R.id.img_existroom3resulttouzi6);
        switch(array[5]) {
            case 1:
        ...
        ImageView soloresult_jpg = (ImageView)findViewById(R.id.img_existroom3result);
